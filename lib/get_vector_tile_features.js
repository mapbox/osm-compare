...
var retrieveTileData = function(layers, x, y, z, callback) {
  var url = 'http://a.tiles.mapbox.com/v4/mapbox.mapbox-streets-v7/' +
    ...
    '/' +
    y +
    '.mvt?access_token=pk.eyJ1IjoiYW1pc2hhIiwiYSI6ImNpcWt1bWc4bjAzOXNmdG04bng4dHVhZ3EifQ.bJK6rpjNmiP3kW2pROdScg';
  vt2geojson(
    {
      uri: url,
      layer: layers
...
var getVectorTileFeatures = function(tiles, layers, callback) {
  ...
  tiles.forEach(function(tile) {
    queue.defer(retrieveTileData, layers, tile[0], tile[1], tile[2]);
  });
